...
/**
 * Hashes are generated by scripts/hash-password.mjs, not here — keep the two
 * in step. The format is `scrypt:<saltHex>:<keyHex>`, colon-separated because
 * dotenv expands `$` and would silently corrupt a `$`-separated hash.
 */
